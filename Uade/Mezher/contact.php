                            ...
                            <div class="row g-4">
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" name='nombre 'id="name" placeholder="Your Name">
                                ...
                                <div class="col-lg-12 col-xl-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="auto" name='auto'placeholder="Auto">
                                ...
                                <div class="col-12">
                                    <div class="form-floating">
                                        <textarea class="form-control" placeholder="Leave a message here" id="mensaje" name="mensaje"
                                ...
                                <div class="col-12">
                                    <button class="btn btn-light w-100 py-3" type="submit" value="Send Email">Send Message</button>
                                </div>
                            </div>
                        </form>
                    </div>
